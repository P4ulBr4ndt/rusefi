...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels.cruiseDesiredSpeed, "Cruise: Desired speed", "kph", 2},
	{engine->outputChannels.cruiseStatus, "Cruise: Status", "", 0},
	{engine->outputChannels.cruiseThrottleOffset, "Cruise: Throttle offset", "%", 2},
	...
	{engine->engineState.jssState, "JSS State", "", 0},
	{engine->engineState.opsState, "OPS State", "", 0},
	...
	{engine->engineState, 96, 2, "acrEngineMovedRecently", ""},
	{engine->engineState, 96, 3, "heaterControlEnabled", ""},
	{engine->engineState, 96, 4, "luaDigitalState0", ""},
	{engine->engineState, 96, 5, "luaDigitalState1", ""},
	{engine->engineState, 96, 6, "luaDigitalState2", ""},
	{engine->engineState, 96, 7, "luaDigitalState3", ""},
	{engine->engineState, 96, 8, "Clutch: down", ""},
	...
	{engine->module<IdleController>().unmock(), 12, 3, "Idle: cranking", ""},
	{engine->module<IdleController>().unmock(), 12, 4, "isIacTableForCoasting", ""},
	{engine->module<IdleController>().unmock(), 12, 5, "Idle: reset", ""},
	{engine->module<IdleController>().unmock(), 12, 6, "Idle: dead zone", ""},
	{engine->module<IdleController>().unmock(), 12, 7, "isBlipping", ""},
	{engine->module<IdleController>().unmock(), 12, 8, "badTps", ""},
	{engine->module<IdleController>().unmock(), 12, 9, "looksLikeRunning", ""},
	{engine->module<IdleController>().unmock(), 12, 10, "looksLikeCoasting", ""},
	{engine->module<IdleController>().unmock(), 12, 11, "looksLikeCrankToIdle", ""},
	{engine->module<IdleController>().unmock(), 12, 12, "Idle: coasting", ""},
	{engine->module<IdleController>().unmock(), 12, 13, "Idle: Closed loop active", ""},
	{engine->module<IdleController>().unmock(), 12, 14, "Idle: idling", ""},
